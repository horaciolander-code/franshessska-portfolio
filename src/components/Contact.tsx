      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-full max-w-sm aspect-[3/4] rounded-2xl overflow-hidden shadow-lg bg-crema mb-8">
              <Image
                src={contact.image}
                alt="Contáctame"
                fill
            ...
            <a
              ...
              className="bg-crimson text-white font-body text-sm px-10 py-4 rounded-full hover:bg-burdeos transition-colors mb-8 inline-flex items-center gap-2"
            ...
            >
              ...
              Agenda tu demo · 30 min sin compromiso
            </a>

            {/* Social links */}
            <div className="flex gap-6">
              <a href={social.instagram} target="_blank" rel="noopener noreferrer" className="text-marron hover:text-crimson transition-colors" aria-label="Instagram">
              ...
              <a href={social.tiktok} target="_blank" rel="noopener noreferrer" className="text-marron hover:text-crimson transition-colors" aria-label="TikTok">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href={social.linkedin} target="_blank" rel="noopener noreferrer" className="text-marron hover:text-crimson transition-colors" aria-label="LinkedIn">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                </svg>
              </a>
              <a href={`mailto:${contact.email}`} className="text-marron hover:text-crimson transition-colors" aria-label="Email">
