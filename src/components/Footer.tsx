import { footer, social, siteConfig } from "@/data/content";

export default function Footer() {
  return (
    <footer className="bg-burdeos text-crema py-16 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
          {/* Brand */}
          <div>
            <p className="font-heading text-3xl text-crema mb-2">
              {siteConfig.name}
            </p>
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2 md:justify-center">
            {footer.links.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="font-body text-sm text-crema/70 hover:text-rosa transition-colors"
              >
                {link.text}
              </a>
            ))}
          ...
          <div className="flex gap-5 md:justify-end">
            <a
              ...
              className="text-crema/70 hover:text-rosa transition-colors"
        ...
        <div className="border-t border-crema/20 mt-10 pt-8 text-center">
          <p className="font-body text-xs text-crema/50">
